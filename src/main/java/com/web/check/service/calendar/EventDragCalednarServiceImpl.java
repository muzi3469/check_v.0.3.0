...
public class EventDragCalednarServiceImpl implements Service{
	...
	public void execute(Model model) {
		...
		boolean saveresult = cd.saveDragDrop(title,start,end,cid,description,bid);
		System.out.println("드래그그그그디비저장결과는!!!!!!!!!!!"+saveresult);
	}
