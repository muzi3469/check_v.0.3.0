...
public class EventSelectCalendarServiceImpl implements Service{
	...
	public void execute(Model model) {
		...
		int saveresult = cd.saveSelectDrop(title,start,end,bid,description);
		
		model.addAttribute("cid",saveresult);
	}
