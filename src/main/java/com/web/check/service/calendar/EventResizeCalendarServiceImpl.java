...
public class EventResizeCalendarServiceImpl implements Service{
	...
	public void execute(Model model) {
		...
		boolean saveresult = cd.saveResizeDrop(title,start,end,cid,description,bid);
		System.out.println("리사이즈즈즈즈디비저장결과는!!!!!!!!!!!"+saveresult);
	}
